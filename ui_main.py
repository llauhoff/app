...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.exit_btn.setGeometry(qtc.QRect(94, 14, 18, 18))
        self.exit_btn.setToolTip("Exit")
        self.exit_shadow = qtw.QGraphicsDropShadowEffect()
        self.exit_shadow.setColor(qtg.QColor(0, 0, 0, 255))
        self.exit_shadow.setBlurRadius(5)
        self.exit_shadow.setXOffset(1)
        self.exit_shadow.setYOffset(1)
        self.exit_btn.setGraphicsEffect(self.exit_shadow)

        self.min_btn = qtw.QPushButton(self.btn_frame)
        self.min_btn.setObjectName("min_btn")
        self.min_btn.setGeometry(qtc.QRect(54, 20, 22, 10))
        self.min_btn.setToolTip("Minimize")
        self.min_shadow = qtw.QGraphicsDropShadowEffect()
        self.min_shadow.setColor(qtg.QColor(0, 0, 0, 255))
        self.min_shadow.setBlurRadius(5)
        self.min_shadow.setXOffset(1)
        self.min_shadow.setYOffset(1)
        ...
        self.title_shadow.setColor(qtg.QColor(0, 0, 0, 125))
        ...
        self.accent_shadow.setColor(qtg.QColor(0, 0, 0, 125))
